...
void instructText(){
 //Instructional text; y is every 35 pixels
  textSize(25); textAlign(RIGHT); fill(0);
  text("Press 'M' for Instructions", width-20, 35);
  text("High Score: " + str(highscore), width-20, 70);
  text("Current Score: " + str(score), width-20, 105);
  text("Boosts: " + str(boosts), width-20, 140);
}
